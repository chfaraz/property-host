...
class _PostSecondScreenState extends State<PostSecondScreen> {
  ...
  String _selectedpropertyDetailSizeType;
  ...
  List<String> _propertyTypeSizeMarla = [
    'Marla',
    'Kanal',
  ];
  ...
  List<String> _getPropertyTypeSize() {
    switch (_selectedpropertySize) {
      case ("Homes"):
        return _propertyTypeHomes;
      case ("Plots"):
        return _propertyTypePlots;
  ...
  Future<bool> runMyFutureGetImagesReference() async {
    ...
    if (_selectedpropertyType == "Homes") {
      ...
      if (_selectedpropertyDetailType == "Residential Plot") {
        ...
        adPost.location = widget._adpost.location;
        adPost.ImageUrls = values;
        createpost.createPostPlots(adPost);
      }
    } else {
      if (_selectedpropertyDetailType == "WareHouse") {
        print("in warfe house");
        adPost.title = widget._adpost.title;
        adPost.desc = widget._adpost.desc;
        adPost.price = widget._adpost.price;
        adPost.Address = widget._adpost.Address;
...
/*  Future<dynamic> postImage(File imageFile) async {
  ...
  // void compressImage(List<dynamic> fileImageArray) async {
  //
  //   print("in compress imgage");
  ...
  //         quality: 5);
  //
  //     fileImageList[i] = compressedImage;
  //   }
  // }
