          ...
          Flexible(
            child: ButtonTheme(
              ...
              child: DropdownButtonFormField(
                ...
                validator: (value) => value == null ? 'Please select a Unit Area' : null,
              ),
            ),
          ),
        ],
                    ...
                    _selectedDay == "Mon"
                        ...
                        : _selectedDay == "Tue"
                            ...
                            : _selectedDay == "Wed"
                                ...
                                : _selectedDay == "Thu"
                                    ? _getDay2Dropdown()
                                    : _selectedDay == "Fri" ? _getDay2Dropdown() : _selectedDay == "Sat" ? _getDay2Dropdown() : _selectedDay == "Sun" ? _getDay2Dropdown() : Container(),
                  ],
                ),
              ),
            ],
...
//                  ),
                    Container(
                      margin: EdgeInsets.only(top: 25, left: 38),
                      child: Column(
                            ...
                            child: RaisedButton.icon(
                              ...
                              label: FlatButton(
                                onPressed: () async {
                                  ...
                                  print("result " + _selectedTime.startTime.format(context) + " - " + _selectedTime.endTime.format(context));
                                },
                                child: Text(
          ...
          child: DropdownButtonFormField(
            decoration: InputDecoration(
                prefixIcon: Container(
                  ...
                  validator: (value) => value == null ? 'Field cant be null' : null,
                ),
              ),
            ),
          ),
